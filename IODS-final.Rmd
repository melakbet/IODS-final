...
data.frame(variable = names(Boston),
           ...
           row.names = NULL) %>%  kable(.,"html", caption="Boston structure table") %>%   kable_styling(bootstrap_options ="striped",  full_width = F, position = "float_left") %>% column_spec(1:1, bold = T) %>% row_spec(0:0, bold = T,  color = "white", background = "#D7261E")
...
kable(head(Boston),"html", caption="The first 6 data of Boston House") %>%   kable_styling(bootstrap_options ="condensed", full_width = F, position = "left") %>% column_spec(1:1) %>% row_spec(0, bold = T,  color = "white", background = "#D7261E")
...
kable(round(Boston_summary, digits = 3),"html", caption="Statistics summary of the Boston dataset") %>%   kable_styling(bootstrap_options ="condensed",  full_width = F, position = "left") %>% column_spec(1:1, bold = T,color = "white", background = "#D7261E") %>% row_spec(0, bold = T,  color = "white", background = "#D7261E")
...
my_model2<- lm(crim ~  dis + rad + black + medv , data = Boston)

my_model3<- lm(crim ~  dis + black + lstat + medv , data = Boston)
#summary(my_model2)
...
sjt.lm(my_model1,my_model2,my_model3,show.header = TRUE,string.dv = "Model-comparison", string.est="Estimate", string.ci = "Conf. Int.", string.p = "p-value",  depvar.labels = c("Model 1", "Model 2", "Model 3"))
